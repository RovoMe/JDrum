 ...
 * as possible.
 * <p>
 * On invoking {@link #takeAll()} the backing {@link FlippingDataContainer} will be flipped which results in the buffer
...
public class InMemoryMessageBroker<T extends InMemoryEntry<V, A>, V extends Serializable, A extends Serializable>
     ...
     */
    private InMemoryBufferState oldState;
    /**
     ...
     *
     * @param drumName          The name of the drum instance. This value is only required to log more appropriate and therefore
     *                          traceable statements
     * @param id                The bucket identifier this broker will act on
