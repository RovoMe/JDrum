...
public interface Drum<V extends ByteSerializer<V>, A extends ByteSerializer<A>>
{
	...
	/**
	 * <p>
	 * Adds an object to the {@link java.util.Set Set} of objects to be
	 * notified on state or statistic changes.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Removes a previously added object from the {@link java.util.Set Set} of
	 * objects which require notifications on state or statistic changes.
	 * </p>
	 */
