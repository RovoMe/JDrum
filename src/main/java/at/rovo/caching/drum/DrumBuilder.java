 ...
 * 64k buffer size and a {@link at.rovo.caching.drum.NullDispatcher}.
 * </p>
 *
 * @param <V>
...
public class DrumBuilder<V extends ByteSerializer<V>, A extends ByteSerializer<A>>
		implements Builder<Drum<V, A>>
{
	// required parameters
	 ...
	 * to instantiate a new {@link at.rovo.caching.drum.DrumImpl DrumImpl}
	 * instance on invoking {@link #build()}.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Returns the class type of the value assigned to the DRUM instance to
	 * build.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Returns the class type of the auxiliary data assigned to the DRUM
	 * instance to build.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Returns the byte size of the buffer at which a merge between the bucket
	 * files an the backing data store occurs for the DRUM instance to create.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Returns the factory which creates the backing storage service for the
	 * DRUM instance to create.
	 * </p>
	 *
