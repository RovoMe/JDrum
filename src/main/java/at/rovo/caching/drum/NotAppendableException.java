...
/**
 * <p>A NotAppendableException marks a failure while trying to append data to 
 * existing data which does not implement the {@link AppendableData} interface.</p>
 * 
...
public class NotAppendableException extends RuntimeException
{
	...
	/**
	 * <p>Creates a new instance of a not appendable exception and sets the error 
